...
{ /* reads a geometric shape file, creates a geometric_shape_type and fills it. */
  ...
  v = s->vertices ;
	rscale = distributions_uniform( 0.5, 1.2 ) ;
  for( i=0 ; i<nvertices ; i++ ) 
  {
...
{ /* charge is bounded between 0 0nd 1. If object is eaten, its inworld_flag is st to zero but type is not changed */
  ...
  o->inworld_flag = 0 ;  /* remove from world */
